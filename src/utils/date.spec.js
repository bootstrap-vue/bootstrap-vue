...
describe('utils/date', () => {
  ...
  it('costrainDate works', async () => {
    ...
    expect(costrainDate(null, null, null)).toEqual(null)
    expect(costrainDate(null, min, max)).toEqual(null)

    expect(costrainDate(date1, null, null)).not.toEqual(null)
    expect(costrainDate(date1, null, null).toISOString()).toEqual(date1.toISOString())

    expect(costrainDate(date1, min, max)).not.toEqual(null)
    expect(costrainDate(date1, min, max).toISOString()).toEqual(date1.toISOString())

    expect(costrainDate(date2, min, max)).not.toEqual(null)
    expect(costrainDate(date2, min, max).toISOString()).toEqual(min.toISOString())
    expect(costrainDate(date2, '', max)).not.toEqual(null)
    expect(costrainDate(date2, '', max).toISOString()).toEqual(date2.toISOString())
    expect(costrainDate(date2, null, max)).not.toEqual(null)
    expect(costrainDate(date2, null, max).toISOString()).toEqual(date2.toISOString())

    expect(costrainDate(date3, min, max)).not.toEqual(null)
    expect(costrainDate(date3, min, max).toISOString()).toEqual(max.toISOString())
    expect(costrainDate(date3, min, '')).not.toEqual(null)
    expect(costrainDate(date3, min, '').toISOString()).toEqual(date3.toISOString())
    expect(costrainDate(date3, min, null)).not.toEqual(null)
    expect(costrainDate(date3, min, null).toISOString()).toEqual(date3.toISOString())
  })
})
