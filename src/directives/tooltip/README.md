...
<div class="bd-example bd-example-tooltip-static">
  ...
  <div class="tooltip bs-tooltip-right bs-tooltip-right-docs" role="tooltip">
    <div class="arrow" style="top:60%" />
    <div class="tooltip-inner">
      Tooltip on the righttop
    </div>
  </div>
  <div class="tooltip bs-tooltip-right bs-tooltip-right-docs" role="tooltip">
    <div class="arrow" style="top:26%" />
    <div class="tooltip-inner">
...
| `template`          | String                          | `'<div class="tooltip" role="tooltip"><div class="arrow" /><div class="tooltip-inner" /></div>'` | Base HTML to use when creating the tooltip. The tooltip's title will be injected into the `.tooltip-inner`, while `.arrow` will become the tooltip's arrow. The outermost wrapper element should have the `.tooltip` class.                                                                                                                                                                                                                                                |
