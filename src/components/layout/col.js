...
export default (resolve, reject) => {
  ...
  // We don't use Vue.extend on the component options, as Vue gets confused when
  // resolving a factory function component that is lazily imported into a project.
  // i.e. cmp = () => import('path/to/component')
  resolve(BCol)
}
