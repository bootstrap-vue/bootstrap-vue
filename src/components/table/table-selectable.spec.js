...
describe('table > row select', () => {
  ...
  it('should not have aria-selected/tabindex attribute when not selectable and no row-clicked listener', async () => {
    ...
    expect($rows.wrappers.every(w => !w.element.matches('tr[aria-selected]'))).toBe(true)
    // Doesn't have tabindex attribute on all TRs
    expect($rows.wrappers.every(w => !w.element.matches('tr[tabindex]'))).toBe(true)
  ...
  it('select mode single works', async () => {
    ...
    expect($rows.at(0).element.matches('[aria-selected="true"]')).toBe(true)
    expect($rows.at(1).element.matches('[aria-selected="false"]')).toBe(true)
    expect($rows.at(2).element.matches('[aria-selected="false"]')).toBe(true)
    expect($rows.at(3).element.matches('[aria-selected="false"]')).toBe(true)
    expect(wrapper.classes()).toContain('b-table-selectable')
    expect(wrapper.classes()).toContain('b-table-select-single')
    ...
    $rows = wrapper.findAll('tbody > tr')
    expect($rows.wrappers.every(w => w.element.matches('[tabindex="0"]'))).toBe(true)
    expect($rows.at(0).element.matches('[aria-selected="false"]')).toBe(true)
    expect($rows.at(1).element.matches('[aria-selected="false"]')).toBe(true)
    expect($rows.at(2).element.matches('[aria-selected="true"]')).toBe(true)
    expect($rows.at(3).element.matches('[aria-selected="false"]')).toBe(true)
    expect(wrapper.classes()).toContain('b-table-selectable')
    expect(wrapper.classes()).toContain('b-table-select-single')
    expect(wrapper.classes()).toContain('b-table-selecting')
  ...
  it('select mode range works', async () => {
    ...
    expect($rows.wrappers.every(w => w.element.matches('[tabindex="0"]'))).toBe(true)
    expect($rows.at(0).element.matches('[aria-selected="true"]')).toBe(true)
    expect($rows.at(1).element.matches('[aria-selected="true"]')).toBe(true)
    expect($rows.at(2).element.matches('[aria-selected="true"]')).toBe(true)
    expect($rows.at(3).element.matches('[aria-selected="false"]')).toBe(true)
    expect(wrapper.classes()).toContain('b-table-selectable')
    expect(wrapper.classes()).toContain('b-table-select-range')
    ...
    expect($rows.at(1).element.matches('[aria-selected="false"]')).toBe(true)
    expect($rows.at(2).element.matches('[aria-selected="false"]')).toBe(true)
    expect($rows.at(3).element.matches('[aria-selected="true"]')).toBe(true)
    expect(wrapper.classes()).toContain('b-table-selectable')
    expect(wrapper.classes()).toContain('b-table-select-range')
    expect(wrapper.classes()).toContain('b-table-selecting')
    expect(wrapper.classes()).not.toContain('b-table-select-single')
