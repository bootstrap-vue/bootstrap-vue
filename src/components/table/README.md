...
| `sortByFormatted` | Boolean                     | Sort the column by the result of the field's `formatter` callback function. Default is `false`. Refer to the [Sorting](#sorting) Section for more details. <span class="badge badge-info small">NEW in 2.0.0-rc.28</span>                                                                                         |
