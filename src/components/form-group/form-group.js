...
export default {
  ...
  render (h) {
    ...
    if (this.hasLabel) {
      ...
      const legendDomProps = children ? {} : { [CONTENT_PROP]: this.label }
    ...
    if (this.hasInvalidFeedback) {
      ...
      if (!$slots['invalid-feedback'] && !$slots['feedback']) {
        domProps = { [CONTENT_PROP]: this.invalidFeedback || this.feedback || '' }
      }
      invalidFeedback = h(
    ...
    if (this.hasValidFeedback) {
      const domProps = $slots['valid-feedback'] ? {} : { [CONTENT_PROP]: this.validFeedback || '' }
      validFeedback = h(
    ...
    if (this.hasDescription) {
      const domProps = $slots['description'] ? {} : { [CONTENT_PROP]: this.description || '' }
      description = h(
        'b-form-text',
