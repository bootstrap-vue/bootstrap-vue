...
<div>
  <b-card title="Card Title"
          img-src="https://placeimg.com/600/300/food/5/"
          img-alt="Image"
          img-top
          tag="article"
...
<div>
  <b-card overlay
          img-src="https://placeimg.com/900/250/sports/6/"
          img-alt="Card Image"
          text-variant="white"
          title="Image Overlay"
          sub-title="Subtitle">
...
<div>
    <b-card-group deck>
        <b-card title="Title"
                img-src="https://placeimg.com/300/300/tech/1/"
                img-alt="Img"
                img-top>
            <p class="card-text">
...
<div>
    <b-card-group columns>
        ...
        <b-card img-src="https://placeimg.com/400/400/tech/1/"
                img-fluid
                img-alt="image"
                overlay>
        </b-card>
        <b-card img-src="https://placeimg.com/400/200/tech/1/"
                img-fluid
                img-alt="image"
                img-top>
            <p class="card-text">
