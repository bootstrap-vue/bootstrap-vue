...
describe('calendar', () => {
  it('has expected base structure', async () => {
    ...
    expect(wrapper.find('.b-calendar>div>header').exists()).toBe(true)
    expect(wrapper.find('.b-calendar>div>header>output').exists()).toBe(true)
    expect(wrapper.find('.b-calendar>div>header>output').attributes('role')).toEqual('status')
    expect(wrapper.find('.b-calendar>div>header>output').attributes('for')).toBeDefined()
    expect(wrapper.find('.b-calendar>div>header>output').attributes('aria-live')).toEqual('polite')
    expect(wrapper.find('.b-calendar>div>header>output').attributes('aria-atomic')).toEqual('true')
