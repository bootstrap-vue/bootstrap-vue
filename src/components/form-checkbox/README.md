...
`options` prop. To have them apper _above_ the inputs generated by `options`, place them in the
named slot `first`.
...
Whenever using multple checkboxes, it is recommended that the checkboxes be placed in a
