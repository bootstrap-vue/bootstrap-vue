  ...
  <div>
    ...
    >
      ...
      <b-carousel-slide caption="First slide"
                        ...
                        img-src="https://placeimg.com/1024/480/technics/2/"
      ></b-carousel-slide>

      <!-- Slides with custom text -->
      <b-carousel-slide img-src="https://placeimg.com/1024/480/technics/4/">
        <h1>Hello world!</h1>
      </b-carousel-slide>

      <!-- Slides with image only -->
      <b-carousel-slide img-src="https://placeimg.com/1024/480/technics/8/">
      </b-carousel-slide>
      ...
      <b-carousel-slide>
        <img slot="img" class="d-block img-fluid w-100" width="1024" height="480"
             src="https://placeimg.com/1024/480/technics/5/" alt="image slot">
      </b-carousel-slide>
