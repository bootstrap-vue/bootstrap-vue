...
declare const BVModalPlugin: BVModalPlugin
export interface BVModalPlugin extends BvPlugin {}
declare const BVToastPlugin: BVToastPlugin
export interface BVModalPlugin extends BvPlugin {}

// Legacy named Component group plugins
