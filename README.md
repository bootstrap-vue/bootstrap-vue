# Bootstrap Vue
[Bootstrap 4](https://v4-alpha.getbootstrap.com/) Components For [VueJS 2](https://vuejs.org/)

[![NPM](https://nodei.co/npm/elixirx.png?downloads=true&downloadRank=true&stars=true)](https://npmjs.com/bootstrap-vue/)
