    ...
    hide(callback) {
        ...
        const complete = () => {
            if (this.$hoverState !== HoverState.SHOW && tip.parentNode) {
                ...
                // Force a re-compile of tooltip in case template has changed.
                this.$tip = null;
            }
            this.cleanTipClass();
    ...
    transitionOnce (complete) {
        ...
        const fnOnce = () => {
            ...
            transEvents.forEach(evtName => {
                this.$tip.removeEventListener(evtName, fnOnce);
            });
