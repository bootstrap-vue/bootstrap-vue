...
import bFormCheckboxes from "./form-checkboxes.vue";
...
import bFormOptgroup from "./form-optgroup";
import bFormOption from "./form-option.vue";
...
export {
    ...
    bFormOptgroup,
    bFormOptgroup as bOptgroup,
    bFormOption,
    bFormOption as bOption,
    bFormSelect,
    bImg,
    bImgLazy,
    bJumbotron,
