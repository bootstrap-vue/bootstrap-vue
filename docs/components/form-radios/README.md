...
> For cross browser consistency, `<b-form-radios>` and `<b-form-radio>` uses
...
<div class="alert alert-danger">
  <p>
    ...
    use <code>&lt;b-form-radios&gt;</code> to gerate a series of radio inputs
...
<template>
  <div>
    ...
    <b-form-radios id="radios1" v-model="selected" :options="options">
    </b-form-radios>
    <br>

    <h5>Radios using sub-component</h5>
    <b-form-radios id="radios2" v-model="selected">
...
<!-- form-radio-1.vue -->
```
Feel free to mix and match `options` and `<b-form-radio>` in `<b-form-radios>`.
...
<template>
  <div>
    <h5>Small radios</h5>
    <b-form-radios v-model="selected"
                   :options="options"
                   size="sm"></b-form-radios>
    <br>
    <h5>Large radios</h5>
    <b-form-radios v-model="selected"
                   :options="options"
                   size="lg"></b-form-radios>
