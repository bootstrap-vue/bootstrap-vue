...
.bv-section {
  ...
  $bv-angle-color-depth: calc(#{$bv-angle-depth-md} + 2rem);
  ...
  &.bv-gray-color {
    // Post CSS or Vue-loader is mangling the <filter>
    ...
    background-image: url(data:image/svg+xml;base64,);
  ...
  @media (min-width: 768px) {
    ...
    &.bv-gray-color {
      background-size: 100% $bv-angle-depth-color;
      padding-top: calc(#{$bv-angle-depth-color} + #{$bv-angle-padding-md});
