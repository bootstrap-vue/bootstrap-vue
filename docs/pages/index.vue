          ...
          <div class="col-md-6 order-md-1 text-center text-md-left pr-md-5">
            ...
            <p class="lead mb-3">
              <span class="bd-text-purple-bright">
                BootstrapVue
              </span> provides one of the most
              comprehensive implementations of
              <span class="bd-text-purple-bright">
                Bootstrap V4
              </span> components and grid system
              available for Vue.js 2.5+, complete with extensive and automated WAI-ARIA
              accessibility markup.
            </p>
            <p class="mb-2 text-muted">
              <a href="https://getbootstrap.com/docs/4.0">
                Bootstrap 4
              </a> is the world's most
              popular framework for building responsive, mobile-first sites.
            </p>
            <p class="mb-4 text-muted">
              <a href="https://vuejs.org">
                Vue.js
              </a> (pronounced /vjuË, like view) is a
