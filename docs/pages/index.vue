          ...
          <b-col tag="aside" cols="12" md="4" order-md="2">
            ...
            >
              ...
              <g filter="url(#logo-shadow)">
                <path class="logo-dark-v" fill="#34495E" d="M747 311L602 562 458 311H227l375 651 376-651z"/>
                ...
                <path class="logo-green-v" fill="#41B883" d="M839 357L600 771 361 357H202l398 690 398-690z"/>
              </g>
            </svg>
          </b-col>
