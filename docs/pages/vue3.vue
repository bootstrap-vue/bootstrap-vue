  ...
  <b-container id="content" fluid="lg" tag="main" class="py-5">
    ...
    <section class="bd-content">
      ...
      <b-alert show variant="warning" class="mt-3">
        @vue/compat support is designed for early migration to Vue.js 3 and will be eventually replaced with <a href="https://bootstrap-vue-next.github.io/bootstrap-vue-next/" rel="noopener">BootstrapVueNext</a>. BootstrapVueNext is currently in <b>Alpha</b>
      </b-alert>
